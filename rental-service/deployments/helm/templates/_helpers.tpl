...
helm.sh/chart: {{ include "rental-service.chart" . }}
{{ include "rental-service.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- default (include "rental-service.fullname" .) .Values.serviceAccount.name }}
{{- else }}
